...
export default function AppRouter() {
    ...
    return (_jsx(Suspense, { fallback: _jsx(Loader, { fullScreen: true }), children: _jsxs(Routes, { children: [_jsxs(Route, { path: "/:lang", element: _jsx(LanguageLayout, {}), children: [_jsx(Route, { index: true, element: _jsx(Home, {}) }), _jsx(Route, { path: "services", element: _jsx(Services, {}) }), _jsx(Route, { path: "work", element: _jsx(Portfolio, {}) }), _jsx(Route, { path: "about", element: _jsx(About, {}) }), _jsx(Route, { path: "contact", element: _jsx(Contact, {}) })] }), _jsx(Route, { path: "*", element: _jsx(NotFound, {}) })] }) }));
}
