/**
 * StepAdditionalInfo.tsx - Step 3: Additional Information (PLACEHOLDER)
 * 
 * Третий шаг формы:
 * - Загрузка файлов
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600">
          Приложите файлы и расскажите подробности
        </p>
      </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div className="flex items-center space-x-3">
          ...
          <div className="text-sm text-yellow-800">
            ...
            <p>FileUpload компонент и дополнительные поля будут добавлены позже</p>
          </div>
        </div>
      </div>
    </div>
