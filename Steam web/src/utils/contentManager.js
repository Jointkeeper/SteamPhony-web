 ...
 */
import { getTemplate } from '../data/content-templates';
// ===============================
...
export class ContentPerformanceTracker {
    ...
    trackPageView(contentId, isUnique = false) {
    ...
    trackTimeOnPage(contentId, timeSpent) {
        const existing = this.metrics.get(contentId) || this.createEmptyMetrics(contentId);
